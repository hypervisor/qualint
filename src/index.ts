...
export { RULES, RULE_IDS, runRules, runProjectRules } from './rules/registry.ts';
export type { ProjectFile, ProjectDiagnosticDraft, RuleDefinition } from './rules/registry.ts';
export { resolveRootRules } from './config/load-config.ts';
